...
@Component({
  selector: 'ngx-product-wise-pm-stock',
  templateUrl: './product-wise-pm-stock.component.html',
  styleUrls: ['./product-wise-pm-stock.component.scss']
})
export class ProductWisePmStockComponent implements OnInit {

  pageNavigation = "Product Wise PM Stock";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `ProductionReport/GetProductWiseRmPmStock?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&productSpecId=${productSpecId}&flag=PM`;
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `ProductionReport/GetProductWiseRmPmStock?reportFormat=Pdf&userId=${userInfo[0].employeeid}&productSpecId=${productSpecId}&flag=PM`;
