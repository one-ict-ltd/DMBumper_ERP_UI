...
@Component({
  selector: 'ngx-production-achievement',
  templateUrl: './production-achievement.component.html',
  styleUrls: ['./production-achievement.component.scss']
})
export class ProductionAchievementComponent implements OnInit {

  pageNavigation = "Product Transfer (FG)";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `ProductionReport/GetProductionAchievement?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&productSpecId=${productSpecId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}`;
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `ProductionReport/GetProductionAchievement?reportFormat=Pdf&userId=${userInfo[0].employeeid}&productSpecId=${productSpecId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}`;
