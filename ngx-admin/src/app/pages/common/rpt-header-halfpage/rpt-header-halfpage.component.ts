...
@Component({
  selector: 'ngx-rpt-header-halfpage',
  templateUrl: './rpt-header-halfpage.component.html',
  styleUrls: ['./rpt-header-halfpage.component.scss']
})
export class RptHeaderHalfpageComponent implements OnInit {
