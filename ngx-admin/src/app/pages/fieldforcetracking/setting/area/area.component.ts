...
export class AreaComponent implements OnInit {
  ...
  private save() {
    if (this.master.Name == "") {
      this.toastrService.danger("Area Name is required!!", "Message");
      ...
      this.fieldforcemasterService.saveArea(this.master).subscribe((returns: any) => {
        if (returns.success) {
          if (button == "update") {
          ...
          //////////////Grid Refresh ///////////////////
          this.getMaster();
          this.fieldforcemasterService.getArea(0).subscribe((data: any) => {
            if (data.success) {
  ...
  private agDelete(event) {
    ...
    this.fieldforcemasterService.deleteArea(this.master).subscribe((returns: any) => {
      if (returns.success) {
  ...
  private agEdit(event) {
    ...
    if (temp === 0) {
      ...
      this.fieldforcemasterService.getArea(this.master.Id).subscribe((data: any) => {
        if (data.success) {
