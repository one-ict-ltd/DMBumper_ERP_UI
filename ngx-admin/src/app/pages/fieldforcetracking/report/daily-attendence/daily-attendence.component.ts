...
// @Component({
//   selector: 'ngx-daily-attendence',
//   templateUrl: './daily-attendence.component.html',
//   styleUrls: ['./daily-attendence.component.scss']
// })
// export class DailyAttendenceComponent implements OnInit {
  ...
  private onExportCSV() {
    ...
    let data = this.bodyData.map((item, index) => {
      return [
        ...
        item.MIOCheckIn,
        item.MIODocPlan,
        item.MIOTotalDocPlan,
        item.MIODocPlanExecution,
        item.MIOChemPlan,
        item.MIOTotalPlanChem,
        item.MIOChemExecution,
        item.AMLogin,
        item.AMCheckIn,
        item.AMDocPlan,
        item.AMTotalDocPlan,
        item.AMDocPlanExecute,
        item.AMChemPlan,
        item.AMTotalPlanChem,
        item.AMChemPlanExecute,
      ];
    });
