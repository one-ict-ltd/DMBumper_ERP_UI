...
@Component({
  selector: "ngx-currentlocationtracker",
  templateUrl: "./currentlocationtracker.component.html",
  styleUrls: ["./currentlocationtracker.component.scss"],
})
export class CurrentlocationtrackerComponent implements OnInit {
  constructor(
  ...
  public pageNavigation = "Current Location Tracker";
  ...
  DropdownChange(ddlName: any) {
    ...
    let resType = this.master.SearchForValue;
    switch (ddlName) {
      case "Z": {
        //Zone
        let code = this.master.ZoneId;
        this.LoadEmployees(code, "Z", resType);
        this.GetDepo(code);
      ...
      case "D": {
        ...
        this.LoadEmployees(code, "D", resType);
        this.GetRegion(code);
        break;
      }
      case "R": {
        ...
        this.LoadEmployees(code, "R", resType);
        this.GetArea(code);
        break;
      }
      case "A": {
        ...
        this.LoadEmployees(code, "A", resType);
      ...
      case "T": {
        ...
        this.LoadEmployees(code, "T", resType);
        break;
      }
      default: {
        this.LoadEmployees("", "", resType);
        break;
      }
    }
