...
@Component({
  selector: "ngx-miovisit",
  templateUrl: "./miovisit.component.html",
  styleUrls: ["./miovisit.component.scss"],
})
export class MiovisitComponent implements OnInit {
  public pageNavigation = "MIO Doctor Visit";
  public tableHeader = [
    "#",
    "Doctor Code",
    "Doctor Name",
  ...
  private getReportData() {
    //this.bodyData = [];
    this.apiUrl = `Report/getMIODoctorVisitReport?ZoneId=${this.master.ZoneId
  ...
  public GenerateReport(buttonAction: any) {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      // debugger;
      // this.bodyData = [];
      // this.apiUrl = `Report/getMIODoctorVisitReport?ZoneId=${this.master.ZoneId}&DepoId=${this.master.DepoId}&RegionId=${this.master.RegionId}&AreaId=${this.master.AreaId}&TerritoryID=${this.master.TerritoryID}&EmpCode=${this.master.MIOName}&fromDate=${this.master.fromDate.toDateString().substring(4, 15)}&toDate=${this.master.toDate.toDateString().substring(4, 15)}`;
      // this.commonService.getReportData(this.apiUrl).subscribe((returns: any) => {
      //   if (returns.success) {
      //     debugger;
      //     this.bodyData = returns.data;
