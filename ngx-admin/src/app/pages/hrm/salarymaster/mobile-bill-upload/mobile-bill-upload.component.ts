...
@Component({
  selector: 'ngx-mobile-bill-upload',
  templateUrl: './mobile-bill-upload.component.html',
  styleUrls: ['./mobile-bill-upload.component.scss']
})
export class MobileBillUploadComponent implements OnInit {
  ...
  constructor(
    ...
    this.columnDefs = [
      ...
      {
        headerName: "Limit Bill Amount",
        field: "billLimit",
        filter: "agNumberColumnFilter",
        valueFormatter: (params) => this.currencyFormatter(params.data.billLimit),
        type: "rightAligned",
        width: 150,
      },
      {
        headerName: "Actual Bill Amount",
        field: "actualBill",
        filter: "agNumberColumnFilter",
        valueFormatter: (params) => this.currencyFormatter(params.data.actualBill),
        type: "rightAligned",
        width: 150,
      },
      {
  ...
  onGridReady(params) {
    ...
    this.SalaryFixedHeadStructureService.GetEmployeeMobileBillById(0).subscribe((data: any) => {
      debugger;
      if (data.success) {
  ...
  public getSalaryHeadAmount() {
    ...
    this.SalaryFixedHeadStructureService.GetEmployeeMobileBillById(this.master.salaryPeriodLoadId).subscribe((data: any) => {
      debugger;
      if (data.success) {
        this.rowData = data.data;
      }
  ...
  public pageNavigation = "Employee's Mobile Bill Upload";//"Employee's Salary Fixed Head Structure";
  ...
  public UploadData() {
    ...
    this.SalaryFixedHeadStructureService.SaveEmployeeMobileBill(this.master.lstMaster).subscribe((retuns: any) => {
      if (retuns.status) {
  ...
  public VerifyData() {
    ...
    this.SalaryFixedHeadStructureService.GetMobileBillUploadDataVerify(this.master.lstMaster).subscribe((retuns: any) => {
      if (retuns.status) {
