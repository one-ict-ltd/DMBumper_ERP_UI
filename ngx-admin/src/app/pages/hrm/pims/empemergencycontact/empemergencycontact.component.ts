...
@Component({
  selector: 'ngx-empemergencycontact',
  templateUrl: './empemergencycontact.component.html',
  styleUrls: ['./empemergencycontact.component.scss']
})
export class EmpemergencycontactComponent implements OnInit {
    ...
    this.activatedRoute.queryParams.subscribe(params => {
      ...
      this.employeeinformationService.GetEmployeeBasicInfoById(this.employeeId).subscribe((data: any) => {
        if (data.success) {
          ...
          this.pageNavigation = this.employeeName + "'s Emergency Contact";
        }
      });
    });
  ...
  onGridReady(params) {
    ...
    this.employeeotherinfoService.GetEmployeeEmergencyContactById(0, this.master.employeeId).subscribe((data: any) => {
      if (data.status) {
        this.rowData = data.data;
      }
    });
  ...
  private agEdit(event) {
    ...
    if (temp === 0) {
      ...
      this.employeeotherinfoService.GetEmployeeEmergencyContactById(familyInfoId, employeeId).subscribe((data: any) => {
        if (data.status) {
