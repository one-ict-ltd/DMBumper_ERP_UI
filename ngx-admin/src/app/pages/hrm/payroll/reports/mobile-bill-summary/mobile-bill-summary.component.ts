...
@Component({
  selector: 'ngx-mobile-bill-summary',
  templateUrl: './mobile-bill-summary.component.html',
  styleUrls: ['./mobile-bill-summary.component.scss']
})
export class MobileBillSummaryComponent implements OnInit {
  ...
  public pageNavigation = "Mobile Bill Summary Report";
  public tableHeader = [
    "#",
    "Full Name",
    "Designation",
  ...
  public GetRptSalarySheetPdf() {
    ...
    //   return false;
    // }
    this.salaryreportService.RptMobileBillSheetSummary(this.companyId, 1, this.master.salaryPeriodId, "Pdf").subscribe((returns: any) => {
