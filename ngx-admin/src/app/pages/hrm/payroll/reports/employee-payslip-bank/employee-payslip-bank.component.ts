...
@Component({
  selector: 'ngx-employee-payslip-bank',
  templateUrl: './employee-payslip-bank.component.html',
  styleUrls: ['./employee-payslip-bank.component.scss']
})
export class EmployeePayslipBankComponent implements OnInit {
  ...
  public GetRptPayslip(employeeId, salaryPeriodId) {
    this.salaryreportService
      .RptPayslipBank(1, 1, employeeId, salaryPeriodId, "Pdf")
      .subscribe((returns: any) => {
