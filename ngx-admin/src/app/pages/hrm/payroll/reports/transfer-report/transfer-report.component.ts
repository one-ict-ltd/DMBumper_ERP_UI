...
export class TransferReportComponent implements OnInit {
  ...
  pageNavigation = "Employee Transfer Report";
  fiscalYearId: number;
  monthName: string;
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalaryReport/GetTransferReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&heldupMonth=${this.commonService.DateFormat(heldupMonth)}&salaryPeriodId=${null}`;
  ...
  private getReportData() {
    ...
    this.apiUrl = "";
    let userInfo = this.commonService.GetUserProfileJson();
    this.apiUrl = `SalaryReport/GetTransferReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&heldupMonth=${this.commonService.DateFormat(heldupMonth)}&salaryPeriodId=${null}`;
