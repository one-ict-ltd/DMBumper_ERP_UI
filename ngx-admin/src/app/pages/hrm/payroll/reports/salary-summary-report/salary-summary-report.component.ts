...
@Component({
  selector: 'ngx-salary-summary-report',
  templateUrl: './salary-summary-report.component.html',
  styleUrls: ['./salary-summary-report.component.scss']
})
export class SalarySummaryReportComponent implements OnInit {
  ...
  public pageNavigation = "Salary Summary Report";
  public tableHeader = [
    "#",
    "Full Name",
    "Designation",
  ...
  public GetRptSalarySheetPdf() {
    ...
    this.salaryreportService.RptSalarySummarySheet(this.companyId, 1, this.master.salaryPeriodId, "Pdf", this.master.salaryTypeId, this.master.typeId, salaryDepotName, false, empTypeName, this.departmentIds).subscribe((returns: any) => {
      this.commonService.GenerateBase64ToReport(returns);
    });
  }
  ...
  public GetRptSalarySheetExcel() {
    let empTypeName = this.master.empTypeSelected == undefined || null ? '' : this.master.empTypeSelected['name'];
    let salaryDepotName = this.master.salaryDepotSelected == undefined || null ? '' : this.master.salaryDepotSelected['name'];
    this.salaryreportService.RptSalarySummarySheet(this.companyId, 1, this.master.salaryPeriodId, "Excel", this.master.salaryTypeId, this.master.typeId, salaryDepotName, false, empTypeName).subscribe((returns: any) => {
      this.commonService.GenerateBase64ToReport(returns);
    });
  }
