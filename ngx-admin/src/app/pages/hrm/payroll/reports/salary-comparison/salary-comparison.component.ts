...
@Component({
  selector: 'ngx-salary-comparison',
  templateUrl: './salary-comparison.component.html',
  styleUrls: ['./salary-comparison.component.scss']
})
export class SalaryComparisonComponent implements OnInit {
...
//userInfo[0].employeeid
    this.salaryreportService.SalaryComparisonReport( "Pdf", 1, this.master.salaryPeriodId).subscribe((returns: any) => {
