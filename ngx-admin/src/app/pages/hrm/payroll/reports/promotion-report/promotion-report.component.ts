...
export class PromotionReportComponent implements OnInit {
  ...
  pageNavigation = "Employee Promotion Report";
  fiscalYearId: number;
  monthName: string;
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalaryReport/GetPromotionReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&heldupMonth=${this.commonService.DateFormat(heldupMonth)}&salaryPeriodId=${null}`;
  ...
  private getReportData() {
    ...
    this.apiUrl = "";
    let userInfo = this.commonService.GetUserProfileJson();
    this.apiUrl = `SalaryReport/GetPromotionReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&heldupMonth=${this.commonService.DateFormat(heldupMonth)}&salaryPeriodId=${null}`;
