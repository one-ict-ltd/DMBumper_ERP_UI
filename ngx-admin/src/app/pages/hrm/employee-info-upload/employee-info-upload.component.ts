...
@Component({
  selector: 'ngx-employee-info-upload',
  templateUrl: './employee-info-upload.component.html',
  styleUrls: ['./employee-info-upload.component.scss']
})
export class EmployeeInfoUploadComponent implements OnInit {
  ...
  public pageNavigation = "Employee's Information  Upload";//"Employee's Salary Fixed Head Structure";
  ...
  onFileChange(evt: any) {
    ...
    reader.onload = (e: any) => {
      ...
      this.data.forEach(e => {
        let joiningdate = new Date(e[4]);
        console.log('Joining Date:', e[4])
        debugger;
        let obj = {
          //EmpFixedHeadStructureId: 0,
          employeeId: 0,
  ...
  public UploadData() {
    ...
    this.employeeinformationService.SaveEmployeeInfofromExcel(this.master.lstMaster).subscribe((retuns: any) => {
      if (retuns.status) {
  ...
  public VerifyData() {
    ...
    this.employeeinformationService.GetEmployeeInfoUploadDataVerify(this.master.lstMaster).subscribe((retuns: any) => {
      if (retuns.status) {
