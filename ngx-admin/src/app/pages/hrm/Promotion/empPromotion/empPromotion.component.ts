...
@Component({
  selector: 'ngx-empPromotion',
  templateUrl: './empPromotion.component.html',
  styleUrls: ['./empPromotion.component.scss']
})
export class EmpPromotionComponent implements OnInit {
  ...
  public pageNavigation = "Employee Promotion";
  ...
  private agEdit(event) {
    ...
    if (temp === 0) {
      ...
      this.employeeinformationService.GetEmployeePromotionById(employeePromotionId).subscribe((data: any) => {
        if (data.status) {
