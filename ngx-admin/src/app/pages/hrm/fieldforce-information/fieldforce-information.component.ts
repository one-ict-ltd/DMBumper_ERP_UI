...
@Component({
  selector: 'ngx-fieldforce-information',
  templateUrl: './fieldforce-information.component.html',
  styleUrls: ['./fieldforce-information.component.scss']
})
export class FieldforceInformationComponent implements OnInit {
  ...
  public pageNavigation = "Field Force Information";
    ...
    if (this.master.employeeNo == "" || this.master.fullName == ""
      ...
      this.employeeinformationService.SaveEmployeeBasicInfo(this.master).subscribe((returns: any) => {
        if (returns.success) {
          ...
          //this.commonService.valueSet("create");
          if (this.master.postingLocation == 'T') {
            debugger;
            this.employeeinformationService.UpdateSalesLimit(this.master.territoryId).subscribe((returns: any) => {
              if (!returns.success) {
                this.toastrService.danger("Sales Creadit not Updated!", "Message");
                return false;
              }
            });
          }
  ...
  constructor(
    ...
    //this.onCheckboxChange(this.master.actionCheckbox);
  }
  ...
  private agEdit(event) {
    ...
    this.router.navigateByUrl(`/pages/hrm/fieldforce-basic?employeeId=${employeeId}`)
  }
