...
@Component({
  selector: 'ngx-leaveapprovalmatrix',
  templateUrl: './leaveapprovalmatrix.component.html',
  styleUrls: ['./leaveapprovalmatrix.component.scss']
})
export class LeaveapprovalmatrixComponent implements OnInit {
  ...
  public addDetails(dialog: TemplateRef<any>) {
    ...
    let detail = {
      ...
      approverId: this.master.approverId??0,
      approverName: this.master.approverSelected["name"]==undefined||null?"":this.master.approverSelected["name"],
