...
@Component({
  selector: 'ngx-leaveregister',
  templateUrl: './leaveregister.component.html',
  styleUrls: ['./leaveregister.component.scss']
})
export class LeaveregisterComponent implements OnInit {
  ...
  public pageNavigation = "Leave Apply";
  ...
  private save() {
    ...
    else if (this.master.leaveDay > this.Balance && this.master.leaveTypeId < 4) {
