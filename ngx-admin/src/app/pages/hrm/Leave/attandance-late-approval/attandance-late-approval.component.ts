...
@Component({
  selector: 'ngx-attandance-late-approval',
  templateUrl: './attandance-late-approval.component.html',
  styleUrls: ['./attandance-late-approval.component.scss']
})
export class AttandanceLateApprovalComponent implements OnInit {
  ...
  public pageNavigation = "Late Approval";
  ...
  private save() {
    ...
    if (this.SaveValidation() == true) {
      this.leaveService
        .SetApproveLateAttandance(this.master)
  ...
  GetLeaveRegisterListForApproval() {
    this.commonService.valueSet("create");
    this.leaveService
      .GetLateAttandanceClarificationForApprovalByEmployeeIdJson()
      .subscribe((returns: any) => {
        if (returns.success) {
