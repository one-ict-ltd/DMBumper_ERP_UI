...
@Component({
  selector: 'ngx-leave-summary-repot',
  templateUrl: './leave-summary-repot.component.html',
  styleUrls: ['./leave-summary-repot.component.scss']
})
export class LeaveSummaryRepotComponent implements OnInit {

  public reportTypeName = "Leave Summary Report";
  public company: {
    name: string;
    address: string;
  ...
  public pageNavigation = "Leave Summary Report";
  public tableHeader = [
    "#",
    "Emp. ID",
    "Name",
  ...
  private getReportData() {
    ...
    this.apiUrl = `LeaveRegister/GetLeaveSummaryReportJson?year=${year}`;
