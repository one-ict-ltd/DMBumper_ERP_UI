...
@Component({
  selector: "ngx-level-of-education",
  templateUrl: "./level-of-education.component.html",
  styleUrls: ["./level-of-education.component.scss"],
})
export class LevelOfEducationComponent implements OnInit {
  public pageNavigation = "Level of Education";
  ...
  private save() {
    if (this.master.levelOfEducationName == "") {
      ...
      this.hrmmasterService
        .SaveLevelOfEducation(this.master)
  ...
  onGridReady(params) {
    ...
    this.hrmmasterService.GetLevelOfEducationById(0).subscribe((data: any) => {
      if (data.success) {
        this.rowData = data.data;
      }
    });
  ...
  private agDelete(event) {
    this.master.levelOfEducationId = event.node.data.levelOfEducationId;
    this.hrmmasterService
      .DeleteLevelOfEducationById(this.master.levelOfEducationId)
      .subscribe((returns: any) => {
        if (returns.success) {
  ...
  private agEdit(event) {
    ...
    if (temp === 0) {
      ...
      this.hrmmasterService
        .GetLevelOfEducationById(this.master.levelOfEducationId)
        .subscribe((data: any) => {
          if (data.success) {
