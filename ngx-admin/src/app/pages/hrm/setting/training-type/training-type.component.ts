...
export class TrainingTypeComponent implements OnInit {
  public pageNavigation = "Training Type";
  ...
  onGridReady(params) {
    ...
    this.hrmmasterService.GetTrainingTypeById(0).subscribe((data: any) => {
      if (data.success) {
        this.rowData = data.data;
      }
    });
  ...
  private agDelete(event) {
    this.master.trainingTypeId = event.node.data.trainingTypeId;
    this.hrmmasterService
      .DeleteTrainingTypeById(this.master.trainingTypeId)
      .subscribe((returns: any) => {
        if (returns.success) {
  ...
  private agEdit(event) {
    ...
    if (temp === 0) {
      ...
      this.hrmmasterService
        .GetTrainingTypeById(this.master.trainingTypeId)
        .subscribe((data: any) => {
          if (data.success) {
