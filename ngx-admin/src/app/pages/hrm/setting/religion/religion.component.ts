...
export class ReligionComponent implements OnInit {
  ...
  public pageNavigation = "Religion";
  ...
  private save() {
    if (this.master.name == "") {
      ...
      this.hrmmasterService.saveEmployeeReligion(this.master).subscribe((returns: any) => {
        if (returns.success) {
          if (button == "update") {
          ...
          //////////////Grid Refresh ///////////////////
          this.getMaster();
          this.hrmmasterService.getEmployeeReligion(0).subscribe((data: any) => {
            if (data.success) {
  ...
  private agDelete(event) {
    this.master.religionId = event.node.data.religionId;
    this.hrmmasterService.deleteEmployeeReligion(this.master).subscribe((returns: any) => {
      if (returns.success) {
  ...
  private agEdit(event) {
    ...
    if (temp === 0) {
      ...
      this.hrmmasterService.getEmployeeReligion(this.master.religionId).subscribe((data: any) => {
        if (data.success) {
