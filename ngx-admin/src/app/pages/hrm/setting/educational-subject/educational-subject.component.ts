...
@Component({
  selector: "ngx-educational-subject",
  templateUrl: "./educational-subject.component.html",
  styleUrls: ["./educational-subject.component.scss"],
})
export class EducationalSubjectComponent implements OnInit {
  public pageNavigation = "Educational Subject";
  ...
  private save() {
    if (this.master.name == "") {
      ...
      this.hrmmasterService
        .SaveEducationalSubject(this.master)
  ...
  private agDelete(event) {
    ...
    this.hrmmasterService
      .DeleteEducationalSubjectById(this.master.subjectId)
      .subscribe((returns: any) => {
        if (returns.success) {
