...
export class BloodgroupComponent implements OnInit {
  ...
  public pageNavigation = "Blood Group";
  ...
  private save() {
    if (this.master.Name == "") {
      ...
      this.hrmmasterService.saveBloodGroup(this.master).subscribe((returns: any) => {
        if (returns.success) {
          if (button == "update") {
          ...
          //////////////Grid Refresh ///////////////////
          this.getMaster();
          this.hrmmasterService.getBloodGroup(0).subscribe((data: any) => {
            if (data.success) {
  ...
  private agDelete(event) {
    this.master.bloodGroupId = event.node.data.bloodGroupId;
    this.hrmmasterService.deleteBloodGroup(this.master).subscribe((returns: any) => {
      if (returns.success) {
  ...
  private agEdit(event) {
    ...
    if (temp === 0) {
      ...
      this.hrmmasterService.getBloodGroup(this.master.bloodGroupId).subscribe((data: any) => {
        if (data.success) {
