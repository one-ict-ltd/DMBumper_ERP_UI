...
export class DepartmentComponent implements OnInit {
  ...
  public pageNavigation = "Department";
  ...
  private save() {
    if (this.master.deptName == "") {
      ...
      this.show = true;
      // var day = this.master.startDate;
      //day.setHours(day.getHours() + 6);
      // this.master.startDate =day;

      var button = this.commonService.buttonClicked;
      this.hrmmasterService.saveDepartment(this.master).subscribe((returns: any) => {
        if (returns.success) {
          if (button == "update") {
          ...
          //////////////Grid Refresh ///////////////////
          this.getMaster();
          this.hrmmasterService.getDepartment(0).subscribe((data: any) => {
            if (data.success) {
  ...
  private agDelete(event) {
    this.master.departmentId = event.node.data.departmentId;
    this.hrmmasterService.deleteDepartment(this.master).subscribe((returns: any) => {
      if (returns.success) {
  ...
  private agEdit(event) {
    ...
    if (temp === 0) {
      ...
      this.hrmmasterService.getDepartment(this.master.departmentId).subscribe((data: any) => {
        if (data.success) {
