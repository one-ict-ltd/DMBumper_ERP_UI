...
export class UsergroupComponent implements OnInit {
  ...
  public pageNavigation = "User Group";
  ...
  private getUserGroup() {
    this.usergroupService.getUserGroup().subscribe((data: any) => {
      if (data.success) {
