...
export class ChangePasswordComponent implements OnInit {
  ...
  public pageNavigation = "Password";
  ...
  private UpdatePassword() {
    if (this.master.Password == '' || this.master.Password == null) {
      this.toastrService.danger("Please give password !!", "Message");
      return false;
    }
    if (this.master.Password != this.master.ConfirmPassword) {
      this.toastrService.danger("Password and confirm password not matched", "Message");
      return false;
    }
    if (this.master.Name == '' || this.master.Name == null) {
      this.toastrService.danger("Old password not matched", "Message");
      return false;
    }

    this.userregisterService.ChangePassword(this.master).subscribe((returns: any) => {
      if (returns.success) {
        this.toastrService.success(
          returns.message,
          "Message"
