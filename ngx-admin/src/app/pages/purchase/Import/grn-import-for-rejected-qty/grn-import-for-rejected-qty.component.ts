...
@Component({
  selector: 'ngx-grn-import-for-rejected-qty',
  templateUrl: './grn-import-for-rejected-qty.component.html',
  styleUrls: ['./grn-import-for-rejected-qty.component.scss']
})
//GrnImportForRejectedQtyComponent
export class GrnImportForRejectedQtyComponent implements OnInit {
  ...
  public pageNavigation = "GRN Import For Return";
  ...
  public getAllRejectedGRNList(id: any) {
    ...
    debugger
    this.PurchaseorderService.getRejectedImportGRN(id).subscribe((returns: any) => {
      if (returns.success) {

        this.rejectedGRNList = returns.data.map((val) => ({
          id: val.PurImpPreLCInfoMasterId,
          name: val.grnNo
  ...
  public getAllLcNo() {
    ...
    this.lcNoList = null;
    //debugger
    this.PurchaseorderService.getLcNoForRejectedQty().subscribe((returns: any) => {
      if (returns.success) {
        //debugger;
  ...
  initGrid(ImpgrnMasterId: any) {
    ...
    this.PurchaseorderService.getGRNImportForReturnOrder(ImpgrnMasterId).subscribe((data: any) => {
      if (data.success) {
        this.rowData = data.data;
        //console.log(this.rowData);
      }
