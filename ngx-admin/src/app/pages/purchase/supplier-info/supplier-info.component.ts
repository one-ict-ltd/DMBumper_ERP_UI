...
export class SupplierInfoComponent implements OnInit {
  ...
  public pageNavigation = "Supplier Management";
...
GetAreaByDepoCode(DepoCode);
  */
  ...
  public getDropdownData() {
    ...
    this.comboService.getOriginCountries(0).subscribe((returns: any) => {
      this.countryOrigins = returns.data.map((val) => ({
        id: val.countryId,
  ...
  private save() {
    ...
    debugger
    if (!this.master.countryOriginSelected || this.master.countryOriginSelected == null || this.master.countryOriginSelected["id"] == null) {
      this.master.originCountryId = null;
    }

    if (!this.master.genderSelected || this.master.genderSelected == null || this.master.genderSelected["id"] == "") {
      this.master.gender = "";
    }
  ...
  ToggleDissabled() {
    ...
    if (this.profile.length > 0) {
      ...
      if ((POSTING_LOCATION != (null)) && POSTING_LOCATION == 'D')
  ...
  private agEdit(event) {
    ...
    if (temp === 0) {
      ...
      this.partyService.getSupplier(partyId).subscribe((data: any) => {
        if (data.success) {
          debugger;
          ...
          this.master.countryOriginSelected = {
            id: data.data[0].originCountryId,
            name: data.data[0].originCountryName,
          };
