...
@Component({
  selector: 'ngx-rpt-purchaseorderheader',
  templateUrl: './rpt-purchaseorderheader.component.html',
  styleUrls: ['./rpt-purchaseorderheader.component.scss']
})
export class RptPurchaseorderheaderComponent implements OnInit {
