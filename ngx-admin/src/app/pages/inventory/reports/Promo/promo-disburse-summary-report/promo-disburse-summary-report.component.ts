...
@Component({
  selector: 'ngx-promo-disburse-summary-report',
  templateUrl: './promo-disburse-summary-report.component.html',
  styleUrls: ['./promo-disburse-summary-report.component.scss']
})
export class PromoDisburseSummaryReportComponent implements OnInit {
  ...
  pageNavigation = "Promo Disburse Summary Report";
  apiUrl = "";
  bodyData: any = [];
  ...
  generateCrReport(reportFormat: any) {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      this.apiUrl = `PromoReport/GetPromoDisburseSummaryReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&depotCode=${depotCode}&territoryCode=${territoryCode}`;
  ...
  private getReportData() {
    ...
    this.apiUrl = "";
    this.apiUrl = `Promo/GetPromoDisburseSummary?fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&depotCode=${depotCode}&territoryCode=${territoryCode}`;
    debugger;
