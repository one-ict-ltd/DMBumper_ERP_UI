...
@Component({
  selector: 'ngx-depottofactoryreceive',
  templateUrl: './depottofactoryreceive.component.html',
  styleUrls: ['./depottofactoryreceive.component.scss']
})
export class DepottofactoryreceiveComponent implements OnInit {
  ...
  public pageNavigation = "FGR Received [Depot To Factory Received]";
  public rptHeader = "Finish Goods Received";
  ...
  generateCrReport(reportFormat: any, stockReceiveId: any) {
    ...
    let reportHeaderName = "FGR Received From Depot"
  ...
  public GetAllProductReceiveNumber(sbuId) {
    this.master.productTransferNoSelected = {};
    this.stockreceive
      .GetAllProductReceiveNumber(sbuId, this.master.receiveType)//'D2F')
      .subscribe((returns: any) => {
