...
@Component({
  selector: 'ngx-stationaries-product-receive',
  templateUrl: './stationaries-product-receive.component.html',
  styleUrls: ['./stationaries-product-receive.component.scss']
})
export class StationariesProductReceiveComponent implements OnInit {
  ...
  public pageNavigation = "Stationaries Product Received";
  ...
  public GetAllProductReceiveNumber(sbuId) {
    this.master.productTransferNoSelected = {};
    this.stockreceive
      .GetAllProductReceiveNumber(sbuId, this.master.receiveType)//'SD2D')
      .subscribe((returns: any) => {
