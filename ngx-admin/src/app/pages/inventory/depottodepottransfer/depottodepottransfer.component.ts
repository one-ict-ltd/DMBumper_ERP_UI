...
@Component({
  selector: 'ngx-depottodepottransfer',
  templateUrl: './depottodepottransfer.component.html',
  styleUrls: ['./depottodepottransfer.component.scss']
})
export class DepottodepottransferComponent implements OnInit {
  ...
  public pageNavigation = "Product Issue (TD) [Depot To Depot Transfer]";
