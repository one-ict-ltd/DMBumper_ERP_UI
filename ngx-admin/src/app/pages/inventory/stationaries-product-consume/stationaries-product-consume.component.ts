...
@Component({
  selector: 'ngx-stationaries-product-consume',
  templateUrl: './stationaries-product-consume.component.html',
  styleUrls: ['./stationaries-product-consume.component.scss']
})
export class StationariesProductConsumeComponent implements OnInit {
  ...
  public pageNavigation = "Stationaries Product Consume";
  public rptHeader = "Stationaries Product Consume";
  ...
  public getSBU(companyId) {
    ...
    this.comboService.getSpecialBranchUnitBySpecificSbuIdJson(companyId).subscribe((returns: any) => {
  ...
  generateCrReport(reportFormat: any, stockTransferId: any) {
    ...
    let reportHeaderName = "Stationaries Product Consume"; //"Product Issue (TD)";
    this.apiUrl = `SalesInvoiceReport/GetStockConsumeReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&stockTransferId=${stockTransferId}&reportHeader=${reportHeaderName}`;
