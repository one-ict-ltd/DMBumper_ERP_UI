...
@Component({
  selector: 'ngx-producttransfer-v2',
  templateUrl: './producttransfer-v2.component.html',
  styleUrls: ['./producttransfer-v2.component.scss']
})
export class ProducttransferV2Component implements OnInit {
  serverDate: any[];
  ...
  public VerifyData() {
    ...
    this.stockinService.GetBatchWisetStock((companyId ?? 1), this.master.storeId).subscribe((res: any) => {
      if (res.success) {
