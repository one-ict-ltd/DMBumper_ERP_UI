...
@Component({
  selector: 'ngx-promo-packet-process',
  templateUrl: './promo-packet-process.component.html',
  styleUrls: ['./promo-packet-process.component.scss']
})
export class PromoPacketProcessComponent implements OnInit {
