...
@Component({
  selector: 'ngx-money-receipt-note',
  templateUrl: './money-receipt-note.component.html',
  styleUrls: ['./money-receipt-note.component.scss']
})
export class MoneyReceiptNoteComponent implements OnInit {
  ...
  ValidationForSave(): boolean {
    ...
    // if (this.master.trxNo.trim() == "") {
    //   // debugger;
    //   this.toastrService.warning("Please input Transaction / Ref. Number", "Message");
    //   return false;
    // }
