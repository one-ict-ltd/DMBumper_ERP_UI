...
@Component({
  selector: 'ngx-salesapprovalmatrix',
  templateUrl: './salesapprovalmatrix.component.html',
  styleUrls: ['./salesapprovalmatrix.component.scss']
})
export class SalesapprovalmatrixComponent implements OnInit {
