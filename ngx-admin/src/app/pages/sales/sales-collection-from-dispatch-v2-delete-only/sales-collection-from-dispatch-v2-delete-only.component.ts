...
@Component({
  selector: 'ngx-sales-collection-from-dispatch-v2-delete-only',
  templateUrl: './sales-collection-from-dispatch-v2-delete-only.component.html',
  styleUrls: ['./sales-collection-from-dispatch-v2-delete-only.component.scss']
})
export class SalesCollectionFromDispatchV2DeleteOnlyComponent implements OnInit {
  ...
  public pageNavigation = "Sales Collections";
  ...
  public GetAllPendingMoneyRecipts() {
    ...
    if (this.master.territoryCode == "") return;
  ...
  GetDiscountPercentMsg(Percent: number = 0, InvoiceNo: string) {
    this.DiscountPercentStatus = InvoiceNo == "" ? "" : `${Percent}% Discount apply in ${InvoiceNo}`;
  }
