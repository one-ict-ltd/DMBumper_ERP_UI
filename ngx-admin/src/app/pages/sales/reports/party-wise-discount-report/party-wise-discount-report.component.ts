...
@Component({
  selector: 'ngx-party-wise-discount-report',
  templateUrl: './party-wise-discount-report.component.html',
  styleUrls: ['./party-wise-discount-report.component.scss']
})
export class PartyWiseDiscountReportComponent implements OnInit {
  ...
  pageNavigation = "Party Wise Discount Report";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetPartyWiseDiscountReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=${this.depotCode}&territoryCode=${this.territoryCode}&partyId=${this.partyId}&discountType=${this.selectedDiscountType}`;
  ...
  GetPartybyDepotCode() {
    ...
    this.salesinvoiceService
      .GetPartybyDepotCode(this.depotCode)
      .subscribe((returns: any) => {
