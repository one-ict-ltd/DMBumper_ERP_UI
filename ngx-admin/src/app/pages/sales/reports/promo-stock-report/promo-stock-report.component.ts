...
@Component({
  selector: 'ngx-promo-stock-report',
  templateUrl: './promo-stock-report.component.html',
  styleUrls: ['./promo-stock-report.component.scss']
})
export class PromoStockReportComponent implements OnInit {
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetPromoStockReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=''&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&productWiseSpecificationId=${productId}`;
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `SalesInvoiceReport/GetPromoStockReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&depotCode=''&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&productWiseSpecificationId=${productId}`;
