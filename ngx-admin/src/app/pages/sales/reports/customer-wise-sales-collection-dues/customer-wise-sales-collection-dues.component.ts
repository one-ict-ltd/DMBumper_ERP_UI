...
@Component({
  selector: 'ngx-customer-wise-sales-collection-dues',
  templateUrl: './customer-wise-sales-collection-dues.component.html',
  styleUrls: ['./customer-wise-sales-collection-dues.component.scss']
})
export class CustomerWiseSalesCollectionDuesComponent implements OnInit {
  ...
  pageNavigation = "Customer Wise Sales, Collection & Dues Details";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetCustomerWiseSalesCollectionDues?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=${this.depotCode}&territoryCode=${this.territoryCode}&partyId=${this.partyId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&cUpToDate=${this.commonService.DateFormat(this.cUpToDate)}&isOverDues=${this.isOverDues}&isDuesAmtOnly=${this.isDuesAmtOnly}&mioCode=${this.mioCode}&colFromDate=${this.commonService.DateFormat(this.colFromDate)}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}`;
  ...
  private getReportData() {
    debugger;
    this.apiUrl = "";
    this.apiUrl = `SalesCollection/GetCustomerWiseSalesCollectionDues?depotCode=${this.depotCode}&territoryCode=${this.territoryCode}&partyId=${this.partyId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&cUpToDate=${this.commonService.DateFormat(this.cUpToDate)}&isOverDues=${this.isOverDues}&isDuesAmtOnly=${this.isDuesAmtOnly}&mioCode=${this.mioCode}&colFromDate=${this.commonService.DateFormat(this.colFromDate)}`; //&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.regionCode}
