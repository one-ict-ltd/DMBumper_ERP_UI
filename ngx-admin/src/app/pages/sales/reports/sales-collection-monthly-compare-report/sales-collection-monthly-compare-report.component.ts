...
@Component({
  selector: 'ngx-sales-collection-monthly-compare-report',
  templateUrl: './sales-collection-monthly-compare-report.component.html',
  styleUrls: ['./sales-collection-monthly-compare-report.component.scss']
})
export class SalesCollectionMonthlyCompareReportComponent implements OnInit {
  ...
  pageNavigation = "Sales Collection: Monthly Compare Report"; //"MIO Wise Sales Budget Report";
  ...
  generateCrReport(reportFormat: any) {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      this.apiUrl = `SalesInvoiceReport/GetMonthlySalesCompareReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&type=${this.reportType}&mioType=${this.mioType}`;
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `SalesInvoiceReport/GetMonthlySalesCompareReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&type=${this.reportType}&mioType=${this.mioType}`;
