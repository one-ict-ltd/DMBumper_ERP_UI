...
@Component({
  selector: 'ngx-rm-stock-report',
  templateUrl: './rm-stock-report.component.html',
  styleUrls: ['./rm-stock-report.component.scss']
})
export class RmStockReportComponent implements OnInit {
  ...
  pageNavigation = "Raw Materials Stock Report (For Factory)";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetRMStockReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=''&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&productWiseSpecificationId=${productId}`;
  ...
  public getAllProduct() {
    this.productService.getTypeWiseProducts(0, 5).subscribe((returns: any) => {
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `SalesInvoiceReport/GetRMStockReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&depotCode=''&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&productWiseSpecificationId=${productId}`;
