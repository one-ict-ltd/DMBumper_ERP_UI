...
@Component({
  selector: 'ngx-territory-officer-wise-sales-col-balance',
  templateUrl: './territory-officer-wise-sales-col-balance.component.html',
  styleUrls: ['./territory-officer-wise-sales-col-balance.component.scss']
})
export class TerritoryOfficerWiseSalesColBalanceComponent implements OnInit {
  ...
  pageNavigation = "Territory Wise Officer Sales Collection Balance (Without Group)";
  ...
  private getReportData() {
    debugger;
    this.apiUrl = "";
    this.apiUrl = `SalesCollection/GetTerritoryOfficerWiseSalesCollectionBalance?depotCode=${this.depotCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&mioCode=${this.mioCode}`;
