...
@Component({
  selector: 'ngx-depot-stationary-stock-report',
  templateUrl: './depot-stationary-stock-report.component.html',
  styleUrls: ['./depot-stationary-stock-report.component.scss']
})
export class DepotStationaryStockReportComponent implements OnInit {
  ...
  pageNavigation = "Depot Stationary Stock Report";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetDepotStationaryStockReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=${this.depotCode}&productWiseSpecificationId=${this.productWiseSpecificationId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}`;
  ...
  private getReportData_bak() {
    debugger;
    this.apiUrl = "";
    this.apiUrl = `SalesCollection/GetDepotStationaryStockReport?depotCode=${this.depotCode}&productWiseSpecificationId=${this.productWiseSpecificationId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}`;
  ...
  private getReportData() {
    ...
    let userInfo = this.commonService.GetUserProfileJson();
    //console.log("userInfo[0].employeeid", userInfo[0].employeeid);
    this.apiUrl = `SalesInvoiceReport/GetDepotStationaryStockReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&depotCode=${this.depotCode}&productWiseSpecificationId=${this.productWiseSpecificationId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}`;
