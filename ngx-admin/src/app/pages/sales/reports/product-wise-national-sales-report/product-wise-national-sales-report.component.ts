...
@Component({
  selector: 'ngx-product-wise-national-sales-report',
  templateUrl: './product-wise-national-sales-report.component.html',
  styleUrls: ['./product-wise-national-sales-report.component.scss']
})
export class ProductWiseNationalSalesReportComponent implements OnInit {
  ...
  pageNavigation = "Product Group Wise National Sales Report";
  ...
  generateCrReport(reportFormat: any) {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      this.apiUrl = `SalesInvoiceReport/GetProductWiseNationalSales?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depoCode=${this.depotCode}&territoryCode=${this.territoryCode}&partyId=${this.partyId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}`;
  ...
  private getPreviewData() {
    ...
    this.apiUrl = "";
    this.apiUrl = `SalesInvoice/GetProductWiseNationalSalesReport?fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&depoCode=${this.depotCode}&territoryCode=${this.territoryCode}&partyId=${this.partyId}`;
    this.commonService.getReportData(this.apiUrl).subscribe((returns: any) => {
      ...
      this.bodyData.forEach(a => {
        ...
        this.totalNetSalesQty += parseFloat(a.netSalesQty);
