...
@Component({
  selector: 'ngx-zone-region-wise-sales-collection-balance',
  templateUrl: './zone-region-wise-sales-collection-balance.component.html',
  styleUrls: ['./zone-region-wise-sales-collection-balance.component.scss']
})
export class ZoneRegionWiseSalesCollectionBalanceComponent implements OnInit {
  ...
  pageNavigation = "Zone & Region Wise Sales, Collection, Balance Report";
  ...
  generateCrReport(reportFormat: any) {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      this.apiUrl = `SalesInvoiceReport/GetZoneRegionWiseSalesCollectionBalance?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&type=${this.reportType}&mioType=${this.mioType}&opening=${this.openingBalance}`;
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = "";
    let userInfo = this.commonService.GetUserProfileJson();
    this.apiUrl = `SalesInvoiceReport/GetZoneRegionWiseSalesCollectionBalance?reportFormat=Pdf&userId=${userInfo[0].employeeid}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&type=${this.reportType}&mioType=${this.mioType}&opening=${this.openingBalance}`;
