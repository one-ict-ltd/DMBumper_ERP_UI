...
@Component({
  selector: 'ngx-depot-stock-report',
  templateUrl: './depot-stock-report.component.html',
  styleUrls: ['./depot-stock-report.component.scss']
})
export class DepotStockReportComponent implements OnInit {
  ...
  pageNavigation = "Depot Wise Stock Report";
