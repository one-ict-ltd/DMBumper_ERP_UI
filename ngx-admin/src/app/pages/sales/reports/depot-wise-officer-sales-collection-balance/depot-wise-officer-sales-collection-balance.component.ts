...
@Component({
  selector: 'ngx-depot-wise-officer-sales-collection-balance',
  templateUrl: './depot-wise-officer-sales-collection-balance.component.html',
  styleUrls: ['./depot-wise-officer-sales-collection-balance.component.scss']
})
export class DepotWiseOfficerSalesCollectionBalanceComponent implements OnInit {
  ...
  pageNavigation = "Territory Wise Officer Sales Collection Balance";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetDepotWiseOfficerSalesCollectionBalance?userId=${userInfo[0].employeeid}&depotCode=${this.depotCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&reportFormat=${reportFormat}&mioCode=${this.mioCode}`;
  ...
  private getReportData() {
    debugger;
    this.apiUrl = "";
    this.apiUrl = `SalesCollection/GetDepotWiseOfficerSalesCollectionBalance?depotCode=${this.depotCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&mioCode=${this.mioCode}`;
