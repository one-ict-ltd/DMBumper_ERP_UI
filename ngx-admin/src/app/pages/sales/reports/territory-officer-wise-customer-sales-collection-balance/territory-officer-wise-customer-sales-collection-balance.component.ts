...
@Component({
  selector: 'ngx-territory-officer-wise-customer-sales-collection-balance',
  templateUrl: './territory-officer-wise-customer-sales-collection-balance.component.html',
  styleUrls: ['./territory-officer-wise-customer-sales-collection-balance.component.scss']
})
export class TerritoryOfficerWiseCustomerSalesCollectionBalanceComponent implements OnInit {
  ...
  pageNavigation = "Territory Wise Customer Sales Collection Balance";
  ...
  generateCrReport(reportFormat: any) {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      this.apiUrl = `SalesInvoiceReport/GetTerritoryOfficerWiseCustomerSalesCollectionBalance?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=${this.depotCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&mioCode=${this.mioCode}`;
  ...
  private getReportData() {
    debugger;
    this.apiUrl = "";
    this.apiUrl = `SalesCollection/GetTerritoryOfficerWiseCustomerSalesCollectionBalance?depotCode=${this.depotCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&mioCode=${this.mioCode}`;
