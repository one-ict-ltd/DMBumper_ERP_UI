...
@Component({
  selector: 'ngx-csd-audit-report',
  templateUrl: './csd-audit-report.component.html',
  styleUrls: ['./csd-audit-report.component.scss']
})
export class CsdAuditReportComponent implements OnInit {
  ...
  pageNavigation = "CSD Report (For Factory)";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetCSDAuditReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=''&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&productWiseSpecificationId=0`;
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `SalesInvoiceReport/GetCSDAuditReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&depotCode=''&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&productWiseSpecificationId=0`;
