...
@Component({
  selector: 'ngx-ra-stock-report',
  templateUrl: './ra-stock-report.component.html',
  styleUrls: ['./ra-stock-report.component.scss']
})
export class RaStockReportComponent implements OnInit {
  ...
  pageNavigation = "Reagent Stock Report (For Factory)";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetRAStockReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=''&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&productWiseSpecificationId=${productId}`;
  ...
  public getAllProduct() {
    this.productService.getTypeWiseProducts(0, 9).subscribe((returns: any) => {
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `SalesInvoiceReport/GetRAStockReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&depotCode=''&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&productWiseSpecificationId=${productId}`;
