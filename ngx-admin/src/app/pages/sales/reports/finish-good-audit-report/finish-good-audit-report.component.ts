...
@Component({
  selector: 'ngx-finish-good-audit-report',
  templateUrl: './finish-good-audit-report.component.html',
  styleUrls: ['./finish-good-audit-report.component.scss']
})
export class FinishGoodAuditReportComponent implements OnInit {
  ...
  pageNavigation = "Finish Goods Stock Report (For Factory)";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetFGCStockAuditReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=''&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&productWiseSpecificationId=${productId}&productTypeName=${this.productTypeName}`;
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `SalesInvoiceReport/GetFGCStockAuditReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&depotCode=''&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&productWiseSpecificationId=${productId}&productTypeName=${this.productTypeName}`;
