...
@Component({
  selector: 'ngx-miowise-sales-budget-report',
  templateUrl: './miowise-sales-budget-report.component.html',
  styleUrls: ['./miowise-sales-budget-report.component.scss']
})
export class MIOWiseSalesBudgetReportComponent implements OnInit {
  ...
  pageNavigation = "Value Wise Sales Target vs Achievement"; //"MIO Wise Sales Budget Report";
  ...
  generateCrReport(reportFormat: any) {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      this.apiUrl = `SalesInvoiceReport/GetMIOSalesBudgetReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&type=${this.reportType}&mioType=${this.mioType}`;
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `SalesInvoiceReport/GetMIOSalesBudgetReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&type=${this.reportType}&mioType=${this.mioType}`;
