...
@Component({
  selector: 'ngx-product-vs-vaccine-sales-compare-report',
  templateUrl: './product-vs-vaccine-sales-compare-report.component.html',
  styleUrls: ['./product-vs-vaccine-sales-compare-report.component.scss']
})
export class ProductVsVaccineSalesCompareReportComponent implements OnInit {
  ...
  pageNavigation = "Product vs Vaccine Sales Compare Report";
  ...
  generateCrReport(reportFormat: any) {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      this.apiUrl = `SalesInvoiceReport/GetProductVsVaccineSalesCompareReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&type=${this.reportType}&mioType=${this.mioType}`;
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `SalesInvoiceReport/GetProductVsVaccineSalesCompareReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&type=${this.reportType}&mioType=${this.mioType}`;
