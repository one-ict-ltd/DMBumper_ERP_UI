...
@Component({
  selector: 'ngx-depot-stock-report-transactional',
  templateUrl: './depot-stock-report-transactional.component.html',
  styleUrls: ['./depot-stock-report-transactional.component.scss']
})
export class DepotStockReportTransactionalComponent implements OnInit {
  ...
  pageNavigation = "Depot Wise Stock Report (Transactiontional Item Only)";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetDepotStockReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=${this.depotCode}&productWiseSpecificationId=${this.productWiseSpecificationId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&isTransactiontional=1`;
  ...
  private getReportData() {
    ...
    let userInfo = this.commonService.GetUserProfileJson();
    //console.log("userInfo[0].employeeid", userInfo[0].employeeid);
    this.apiUrl = `SalesInvoiceReport/GetDepotStockReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&depotCode=${this.depotCode}&productWiseSpecificationId=${this.productWiseSpecificationId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&isTransactiontional=1`;
