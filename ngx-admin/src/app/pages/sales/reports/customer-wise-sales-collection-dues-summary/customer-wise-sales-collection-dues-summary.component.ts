...
@Component({
  selector: 'ngx-customer-wise-sales-collection-dues-summary',
  templateUrl: './customer-wise-sales-collection-dues-summary.component.html',
  styleUrls: ['./customer-wise-sales-collection-dues-summary.component.scss']
})
export class CustomerWiseSalesCollectionDuesSummaryComponent implements OnInit {
  ...
  pageNavigation = "Customer Wise Sales, Collection & Dues Summary";
