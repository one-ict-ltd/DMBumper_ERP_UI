...
@Component({
  selector: 'ngx-sales-product-return',
  templateUrl: './sales-product-return.component.html',
  styleUrls: ['./sales-product-return.component.scss']
})
export class SalesProductReturnComponent implements OnInit {
  ...
  pageNavigation = "Sales Product Return Report";
  ...
  //   this.apiUrl = "";
  //   this.apiUrl = `SalesReturn/GetSalesProductReturnReport?masterId=${0}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&depotCode=${depotCode}&territoryCode=${territoryCode}&productSpecId=${productWiseSpecificationId}&partyId=${partyId}`;
  //   debugger;
  ...
  generateCrReport(reportFormat: any) {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      this.apiUrl = `SalesInvoiceReport/GetSalesProductReturnReport?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&masterId=${0}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&depotCode=${depotCode}&territoryCode=${territoryCode}&productSpecId=${productWiseSpecificationId}&partyId=${partyId}`;
  ...
  private getReportData() {
    ...
    //this.apiUrl = `SalesReturn/GetSalesProductReturnReport?masterId=${0}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&depotCode=${depotCode}&territoryCode=${territoryCode}&productSpecId=${productWiseSpecificationId}&partyId=${partyId}`;
    this.apiUrl = `SalesInvoiceReport/GetSalesProductReturnReport?reportFormat=Pdf&userId=${userInfo[0].employeeid}&masterId=${0}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&depotCode=${depotCode}&territoryCode=${territoryCode}&productSpecId=${productWiseSpecificationId}&partyId=${partyId}`;
