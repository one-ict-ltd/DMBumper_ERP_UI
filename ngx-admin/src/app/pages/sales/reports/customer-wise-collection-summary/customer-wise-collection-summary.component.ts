...
@Component({
  selector: 'ngx-customer-wise-collection-summary',
  templateUrl: './customer-wise-collection-summary.component.html',
  styleUrls: ['./customer-wise-collection-summary.component.scss']
})
export class CustomerWiseCollectionSummaryComponent implements OnInit {
  ...
  pageNavigation = "Collection Summary";//"Customer Wise Collection";
  ...
  generateCrReport(reportFormat: any) {
    ...
    this.apiUrl = `SalesInvoiceReport/GetCustomerWiseCollectionSummary?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&depotCode=${this.depotCode}&territoryCode=${this.territoryCode}&partyId=${this.partyId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&cUpToDate=${this.commonService.DateFormat(this.cUpToDate)}&isOverDues=${this.isOverDues}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}`;
  ...
  public getAllDropdown() {
    // Tender/bill: load only customers that have bill-sourced invoices (no zone/region/area/depot/territory)
  ...
  private getReportData() {
    debugger;
    this.apiUrl = "";
    this.apiUrl = `SalesCollection/GetCustomerWiseCollectionSummary?depotCode=${this.depotCode}&territoryCode=${this.territoryCode}&partyId=${this.partyId}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&cUpToDate=${this.commonService.DateFormat(this.cUpToDate)}&isOverDues=${this.isOverDues}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}`;
    ...
    this.commonService.getReportData(this.apiUrl).subscribe((returns: any) => {
      ...
      this.bodyData.forEach(a => {
        ...
        this.totalVatAdjustment += parseFloat(a.vatAdjustment);
