...
@Component({
  selector: 'ngx-miowise-sales-budget-report-with-sort',
  templateUrl: './miowise-sales-budget-report-with-sort.component.html',
  styleUrls: ['./miowise-sales-budget-report-with-sort.component.scss']
})
export class MIOWiseSalesBudgetReportWithSortComponent implements OnInit {
  ...
  SortBy: any = "";
  SortBySelected: any = { id: '', name: 'System Default' };
  SortByList: any[] = [
    { id: '', name: 'System Default' },

    { id: 'regionName', name: 'Region Name' },
    { id: 'regionCode', name: 'Region Code' },
    { id: 'areaName', name: 'Area Name' },
    { id: 'areaCode', name: 'Area Code' },
    { id: 'territoryName', name: 'Territory Name' },
    { id: 'territoryCode', name: 'Territory Code' },
    { id: 'mioName', name: 'MIO / AM Name' },
    { id: 'mioCode', name: 'MIO Code' },
    { id: 'HQ', name: 'HQ' },
    { id: 'budgetValue', name: 'Budget' },
    { id: 'mtdSalesValue', name: 'MTD Sales' },
    { id: 'salesAchPercent', name: 'Sales Achieve %' },
    { id: 'salesAchDiffValue', name: 'Achieve (+/-)' },
    { id: 'mtdCollValue', name: 'MTD Collection' },
    { id: 'collAchPercent', name: 'MTD Achieve %' },
    { id: 'collAchDiffValue', name: 'MTD Achieve (+/-)' },
    { id: 'SalesVsCollPercent', name: 'Sales vs Coll. %' },
    { id: 'obAsOn', name: 'Opening Balance as on' },
    { id: 'closingAsOn', name: 'Closing Balance as on' },
    { id: 'duesVarience', name: 'Dues Varience' },
    { id: 'duesDaysOver', name: 'Dues 45 Days Over' }
  ];

  SortOrder: any = "";
  SortOrderSelected: any = { id: '', name: 'System Default' };
  SortOrderList: any[] = [
    { id: '', name: 'System Default' },
  ...
  pageNavigation = "Value Wise Sales Target vs Achievement With Sort"; //"MIO Wise Sales Budget Report";
  ...
  generateCrReport(reportFormat: any) {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      this.apiUrl = `SalesInvoiceReport/GetMIOSalesBudgetReportWithSort?reportFormat=${reportFormat}&userId=${userInfo[0].employeeid}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&type=${this.reportType}&mioType=${this.mioType}&sortParams=${this.paramValue}`;
  ...
  addToSortParam() {
    debugger;
    if (this.SortBySelected == undefined || this.SortBySelected == null || (this.SortBySelected["id"] == "" || this.SortOrderSelected["id"] == "")) {
      this.toastrService.warning('Please select a Sort By & Sort Order param', 'Warning');
      return;
    }

    this.paramText = `${this.paramText} ${this.SortBySelected["name"]} ${this.SortOrderSelected["name"]};`;
    this.paramValue = `${this.paramValue} ${this.SortBySelected["id"]} ${this.SortOrderSelected["id"]},`;
  }
  refeshSortParam() {
    this.paramText = '';
    this.paramValue = '';

    this.SortOrderSelected = { id: '', name: 'System Default' };
    this.SortBySelected = { id: '', name: 'System Default' };
  }
  ...
  private GetPreviewData() {
    ...
    this.apiUrl = `SalesInvoiceReport/GetMIOSalesBudgetReportWithSort?reportFormat=Pdf&userId=${userInfo[0].employeeid}&zoneCode=${this.zoneCode}&regionCode=${this.regionCode}&areaCode=${this.areaCode}&territoryCode=${this.territoryCode}&fDate=${this.commonService.DateFormat(this.fDate)}&tDate=${this.commonService.DateFormat(this.tDate)}&type=${this.reportType}&mioType=${this.mioType}&sortParams=${this.paramValue}`;
