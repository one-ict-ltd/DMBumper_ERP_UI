...
@Component({
  selector: 'ngx-remittance-delete',
  templateUrl: './remittance-delete.component.html',
  styleUrls: ['./remittance-delete.component.scss']
})
export class RemittanceDeleteComponent implements OnInit {
