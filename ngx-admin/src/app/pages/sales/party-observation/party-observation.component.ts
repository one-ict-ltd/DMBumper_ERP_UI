...
@Component({
  selector: 'ngx-party-observation',
  templateUrl: './party-observation.component.html',
  styleUrls: ['./party-observation.component.scss']
})
export class PartyObservationComponent implements OnInit {
  ...
  public pageNavigation = "Party Observation";
