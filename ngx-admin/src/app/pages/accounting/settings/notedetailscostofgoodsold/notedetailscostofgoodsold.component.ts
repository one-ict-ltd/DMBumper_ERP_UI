...
@Component({
  selector: 'ngx-notedetailscostofgoodsold',
  templateUrl: './notedetailscostofgoodsold.component.html',
  styleUrls: ['./notedetailscostofgoodsold.component.scss']
})
export class NotedetailscostofgoodsoldComponent implements OnInit {
  ...
  public pageNavigation = "Cost of Goods sold(COGS) Note Details";
  ...
  public getDuplicate(ledgerId) {
    //debugger;
    this.notedetailsblsheetService.getDuplicateNoteDetail(this.master.noteDetailsId, ledgerId, 'COGS').subscribe((returns: any) => {
      //debugger;
  ...
  private save() {
    ...
    this.notedetailsblsheetService.saveNoteDetails(this.master).subscribe((returns: any) => {
      ...
      if (returns.success) {
        ...
        //////////////Grid Refresh ///////////////////
        //let type = "COGS";
        this.notedetailsblsheetService.getNoteDetails('COGS').subscribe((data: any) => {
          if (data.success) {
  ...
  public getDdlNoteMaster() {
    ...
    this.comboService.getNoteMaster(this.master.companyId, this.master.sbuId, 0, 'COGS').subscribe((returns: any) => {
