...
@Component({
  selector: 'ngx-notemasterincomestment',
  templateUrl: './notemasterincomestment.component.html',
  styleUrls: ['./notemasterincomestment.component.scss']
})
export class NotemasterincomestmentComponent implements OnInit {
  ...
  public pageNavigation = "Income Statement Note Master";
  ...
  private save() {
    ...
    this.notemasterblsheetService.saveNoteMaster(this.master).subscribe((returns: any) => {
      ...
      if (returns.success) {
        ...
        this.show = true;
        //////////////Grid Refresh ///////////////////
        this.notemasterblsheetService.getNoteMaster("IST").subscribe((data: any) => {
          if (data.success) {
  ...
  public GetNoteParent() {
    this.comboService.GetNoteParentByType("IST").subscribe((returns: any) => {
