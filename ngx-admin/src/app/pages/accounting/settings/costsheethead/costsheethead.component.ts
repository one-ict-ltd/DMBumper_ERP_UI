...
@Component({
  selector: 'ngx-costsheethead',
  templateUrl: './costsheethead.component.html',
  styleUrls: ['./costsheethead.component.scss']
})
export class CostsheetheadComponent implements OnInit {
  ...
  public pageNavigation = "Cost Head";
  ...
  public getDuplicate() {
    this.costsheetheadService.GetDuplicateCostSheetHead(this.master.costSheetHeadId, this.master.costHeadName)
  ...
  private save() {
    ...
    this.costsheetheadService.SaveCostSheetHead(this.master).subscribe((returns: any) => {
      //debugger;
      if (returns.success) {
        if (button == "update") {
        ...
        this.show = true;
        //////////////Grid Refresh ///////////////////
        this.costsheetheadService.GetCostSheetHeadById(0, 0).subscribe((data: any) => {
          if (data.success) {
  ...
  private agEdit(event) {
    ...
    if (temp === 0) {
      ...
      this.costsheetheadService.GetCostSheetHeadById(costSheetHeadId, 0).subscribe((data: any) => {
        if (data.success) {
          //debugger;
  ...
  private agDelete(event) {
    ...
    if (result) {
      ...
      this.costsheetheadService.DeleteCostSheetHeadById(this.master.costSheetHeadId)
        .subscribe((returns: any) => {
          if (returns.success) {
