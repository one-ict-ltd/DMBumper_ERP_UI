...
@Component({
  selector: 'ngx-notedetailscashflowindirect',
  templateUrl: './notedetailscashflowindirect.component.html',
  styleUrls: ['./notedetailscashflowindirect.component.scss']
})
export class NotedetailscashflowindirectComponent implements OnInit {
  ...
  public pageNavigation = "Cash Flow (Indirect) Note Details";
  ...
  public getDuplicate(ledgerId) {
    //debugger;
    this.notedetailsblsheetService.getDuplicateNoteDetail(this.master.noteDetailsId, ledgerId, 'CFSI').subscribe((returns: any) => {
      //debugger;
  ...
  private save() {
    ...
    this.notedetailsblsheetService.saveNoteDetails(this.master).subscribe((returns: any) => {
      ...
      if (returns.success) {
        ...
        //////////////Grid Refresh ///////////////////
        //let type = "CFSI";
        this.notedetailsblsheetService.getNoteDetails('CFSI').subscribe((data: any) => {
          if (data.success) {
  ...
  public getDdlNoteMaster() {
    ...
    this.comboService.getNoteMaster(this.master.companyId, this.master.sbuId, 0, 'CFSI').subscribe((returns: any) => {
