...
@Component({
  selector: 'ngx-notemasterblsheet',
  templateUrl: './notemasterblsheet.component.html',
  styleUrls: ['./notemasterblsheet.component.scss']
})
export class NotemasterblsheetComponent implements OnInit {
  ...
  public pageNavigation = "Balance Sheet Note Master";
  ...
  private save() {
    ...
    this.notemasterblsheetService.saveNoteMaster(this.master).subscribe((returns: any) => {
      ...
      if (returns.success) {
        ...
        this.show = true;
        //////////////Grid Refresh ///////////////////
        this.notemasterblsheetService.getNoteMaster('BS').subscribe((data: any) => {
          if (data.success) {
  ...
  public GetNoteParent() {
    this.comboService.GetNoteParentByType("BS").subscribe((returns: any) => {
