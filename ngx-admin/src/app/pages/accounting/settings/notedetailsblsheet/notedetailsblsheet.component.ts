...
@Component({
  selector: 'ngx-notedetailsblsheet',
  templateUrl: './notedetailsblsheet.component.html',
  styleUrls: ['./notedetailsblsheet.component.scss']
})
export class NotedetailsblsheetComponent implements OnInit {
  ...
  public pageNavigation = "Balance Sheet Note Details";
  ...
  public getDuplicate(ledgerId) {
    //debugger;
    this.notedetailsblsheetService.getDuplicateNoteDetail(this.master.noteDetailsId, ledgerId, 'BS').subscribe((returns: any) => {
      //debugger;
  ...
  private save() {
    ...
    this.notedetailsblsheetService.saveNoteDetails(this.master).subscribe((returns: any) => {
      ...
      if (returns.success) {
        ...
        //////////////Grid Refresh ///////////////////
        // let type = "BS";
        this.notedetailsblsheetService.getNoteDetails('BS').subscribe((data: any) => {
          if (data.success) {
  ...
  public getDdlNoteMaster() {
    ...
    this.comboService.getNoteMaster(this.master.companyId, this.master.sbuId, 0, 'BS').subscribe((returns: any) => {
