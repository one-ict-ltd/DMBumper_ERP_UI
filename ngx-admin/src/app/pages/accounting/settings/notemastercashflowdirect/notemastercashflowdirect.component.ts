...
@Component({
  selector: 'ngx-notemastercashflowdirect',
  templateUrl: './notemastercashflowdirect.component.html',
  styleUrls: ['./notemastercashflowdirect.component.scss']
})
export class NotemastercashflowdirectComponent implements OnInit {
  ...
  public pageNavigation = "Cash Flow (Direct) Note Master";
  ...
  private save() {
    ...
    this.notemasterblsheetService.saveNoteMaster(this.master).subscribe((returns: any) => {
      ...
      if (returns.success) {
        ...
        this.show = true;
        //////////////Grid Refresh ///////////////////
        this.notemasterblsheetService.getNoteMaster("CFSD").subscribe((data: any) => {
          if (data.success) {
  ...
  public GetNoteParent() {
    this.comboService.GetNoteParentByType("CFSD").subscribe((returns: any) => {
