...
@Component({
  selector: 'ngx-notedetailscashflowdirect',
  templateUrl: './notedetailscashflowdirect.component.html',
  styleUrls: ['./notedetailscashflowdirect.component.scss']
})
export class NotedetailscashflowdirectComponent implements OnInit {
  ...
  public pageNavigation = "Cash Flow (Direct) Note Details";
  ...
  public getDuplicate(ledgerId) {
    //debugger;
    this.notedetailsblsheetService.getDuplicateNoteDetail(this.master.noteDetailsId, ledgerId, 'CFSD').subscribe((returns: any) => {
      //debugger;
  ...
  private save() {
    ...
    this.notedetailsblsheetService.saveNoteDetails(this.master).subscribe((returns: any) => {
      ...
      if (returns.success) {
        ...
        //////////////Grid Refresh ///////////////////
        //let type = "CFSD";
        this.notedetailsblsheetService.getNoteDetails('CFSD').subscribe((data: any) => {
          if (data.success) {
  ...
  public getDdlNoteMaster() {
    ...
    this.comboService.getNoteMaster(this.master.companyId, this.master.sbuId, 0, 'CFSD').subscribe((returns: any) => {
