...
@Component({
  selector: 'ngx-notemastercashflowindirect',
  templateUrl: './notemastercashflowindirect.component.html',
  styleUrls: ['./notemastercashflowindirect.component.scss']
})
export class NotemastercashflowindirectComponent implements OnInit {
  ...
  public pageNavigation = "Cash Flow (Indirect) Note Master";
  ...
  private save() {
    ...
    this.notemasterblsheetService.saveNoteMaster(this.master).subscribe((returns: any) => {
      ...
      if (returns.success) {
        ...
        this.show = true;
        //////////////Grid Refresh ///////////////////
        this.notemasterblsheetService.getNoteMaster("CFSI").subscribe((data: any) => {
          if (data.success) {
  ...
  public GetNoteParent() {
    this.comboService.GetNoteParentByType("CFSI").subscribe((returns: any) => {
