...
@Component({
  selector: 'ngx-factory-voucher-posting',
  templateUrl: './factory-voucher-posting.component.html',
  styleUrls: ['./factory-voucher-posting.component.scss']
})
export class FactoryVoucherPostingComponent implements OnInit {
