...
@Component({
  selector: 'ngx-posted-voucher-posting',
  templateUrl: './posted-voucher-posting.component.html',
  styleUrls: ['./posted-voucher-posting.component.scss']
})
export class PostedVoucherPostingComponent implements OnInit {
