...
@Component({
  selector: "ngx-contravoucher",
  templateUrl: "./contravoucher.component.html",
  styleUrls: ["./contravoucher.component.scss"],
})
export class ContravoucherComponent implements OnInit {
  ...
  public pageNavigation = "Contra Voucher";
  ...
  public getVoucher() {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      this.voucherService.getVoucherWithDate(0, 1, this.commonService.DateFormat(this.master.loadFromDateShow), this.commonService.DateFormat(this.master.loadToDateShow)).subscribe((data: any) => {
        //debugger;
        if (data.success) {
  ...
  public getVoucherNo() {
    ...
    this.voucherService
      .getVoucherNo(1, this.master.voucherDateShow.toDateString())
      .subscribe((returns: any) => {
        console.log(returns);
  ...
  getServerDateTime() {
    ...
    this.commonService.getApiData(apiUrl).subscribe((returns: any) => {
      if (returns.success) {
        ...
        this.minDate = this.dateService.addDay(new Date(returns.data[0].minVoucherDateCV), 0);
        this.maxDate = this.dateService.addDay(new Date(returns.data[0].maxVoucherDateCV), 0);
