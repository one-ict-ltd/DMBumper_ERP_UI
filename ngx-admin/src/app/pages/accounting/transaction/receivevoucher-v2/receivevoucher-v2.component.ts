...
@Component({
  selector: 'ngx-receivevoucher-v2',
  templateUrl: './receivevoucher-v2.component.html',
  styleUrls: ['./receivevoucher-v2.component.scss']
})
export class ReceivevoucherV2Component implements OnInit {
  ...
  public pageNavigation = "Receipt Voucher";
  ...
  public getVoucherNo() {
    ...
    this.voucherService
      .getVoucherNo(4, this.master.voucherDateShow.toDateString())
      .subscribe((returns: any) => {
        console.log(returns);
  ...
  public getVoucher() {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      this.voucherService.getVoucherWithDate(0, 4, this.commonService.DateFormat(this.master.loadFromDateShow), this.commonService.DateFormat(this.master.loadToDateShow)).subscribe((data: any) => {
        //debugger;
        if (data.success) {
  ...
  getServerDateTime() {
    ...
    this.commonService.getApiData(apiUrl).subscribe((returns: any) => {
      if (returns.success) {
        ...
        this.minDate = this.dateService.addDay(new Date(returns.data[0].minVoucherDateRV), 0);
        this.maxDate = this.dateService.addDay(new Date(returns.data[0].maxVoucherDateRV), 0);
  ...
  private agReport(event, halfFull) {
    ...
    this.getCrReport(event.data.voucherMasterId);
  }
