...
@Component({
  selector: "ngx-visaworkorderposting",
  templateUrl: "./visaworkorderposting.component.html",
  styleUrls: ["./visaworkorderposting.component.scss"],
})
export class VisaworkorderpostingComponent implements OnInit {
  public company: {
    name: string;
    address: string;
  ...
  public pageNavigation = "Visa Work Order Posting";
  ...
  private save() {
    ...
    this.workorderService
      .createAutoJournalForWorkOrder(this.master)
      .subscribe((returns: any) => {
        ...
        if (returns.success) {
          ...
          //////////////Grid Refresh ///////////////////
          this.workorderService
            .getVisaWorkOrder(this.master.allData)
            .subscribe((data: any) => {
              if (data.success) {
