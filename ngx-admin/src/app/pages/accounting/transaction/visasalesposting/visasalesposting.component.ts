...
@Component({
  selector: "ngx-visasalesposting",
  templateUrl: "./visasalesposting.component.html",
  styleUrls: ["./visasalesposting.component.scss"],
})
export class VisasalespostingComponent implements OnInit {
  public company: {
    name: string;
    address: string;
  ...
  public pageNavigation = "Visa Sales Posting";
  ...
  private save() {
    ...
    this.visasalesService
      .createAutoReceiveVoucherForSales(this.master)
      .subscribe((returns: any) => {
        ...
        if (returns.success) {
          ...
          //////////////Grid Refresh ///////////////////
          this.visasalesService
            .getVisaSales(this.master.allData)
            .subscribe((data: any) => {
              if (data.success) {
    ...
    this.columnDefs = [
      ...
      },
      {
        ...
        valueFormatter: (params) =>
          this.currencyFormatter(params.data.salesAmount),
        type: "rightAligned",
        width: 140,
      },
      {
    ...
    this.visasalesService
      ...
      .subscribe((returns: any) => {
        if (returns.success) {
          ...
          this.salesDate = this.bodyData[0].salesDate;
