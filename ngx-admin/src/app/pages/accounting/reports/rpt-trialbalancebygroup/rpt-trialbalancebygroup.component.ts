...
@Component({
  selector: 'ngx-rpt-trialbalancebygroup',
  templateUrl: './rpt-trialbalancebygroup.component.html',
  styleUrls: ['./rpt-trialbalancebygroup.component.scss']
})
export class RptTrialbalancebygroupComponent implements OnInit {

  public pageNavigation = "Trial Balance (Group Wise)";
  public tableHeader = [
    "#",
    "Group Code",
    "Group Name",
  ...
  private getReportData() {
    ...
    this.apiUrl = `AccountReport/getRptTrialBalance?companyId=${this.ddlSelected.id
        ...
        .substring(3, 15)}&toDate=${this.todateSelected
          .toString()
          .substring(3, 15)}&rptType=GroupWise`;
  ...
  public generateReport(reportFormat: any) {
    ...
    //   this.getReportData();
    //   const content = document.getElementById("reportHeader");
    //   this.generatePdfTrial(reportFormat, fileName, content);
    // }
  ...
  private getCrReport(reportFormat: any = 'pdf') {//"AccountsReport/GetTrialBalanceReport?"
    ...
    this.apiUrl = `AccountsReport/GetTrialBalanceReport?companyId=${this.ddlSelected.id
      ...
      )}&toDate=${this.commonService.DateFormat(this.todateSelected)}&rptType=GroupWise&reportFormat=${reportFormat}`;
  ...
  public getLedgersList(dialog: TemplateRef<any>, accountGroupId) {
    this.apiUrlLedgerList = `AccountReport/getRptTrialBalance?companyId=${this.ddlSelected.id
      }&sbuId=${this.branchSelected.id}&accountGroupId=${accountGroupId}&fromDate=${this.fromdateSelected
        .toString()
        .substring(3, 15)}&toDate=${this.todateSelected
          .toString()
  ...
  private getReportDataExcel() {
    this.apiUrl = `AccountReport/getRptTrialBalance?companyId=${this.ddlSelected.id}&sbuId=${this.branchSelected.id}&accountGroupId=0&fromDate=${this.fromdateSelected.toString().substring(3, 15)}&toDate=${this.todateSelected
      .toString().substring(3, 15)}&rptType=GroupWise`;
