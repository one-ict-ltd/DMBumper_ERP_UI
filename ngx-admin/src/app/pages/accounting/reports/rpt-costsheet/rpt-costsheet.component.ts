...
@Component({
  selector: 'ngx-rpt-costsheet',
  templateUrl: './rpt-costsheet.component.html',
  styleUrls: ['./rpt-costsheet.component.scss']
})
export class RptCostsheetComponent implements OnInit {

  public date = new Date().getFullYear();
  public fromdateSelected = new Date();
  public todateSelected = new Date();

  public pageNavigation = "Statement of Cost & Profit";
  ...
  public yearEndDate = "";
  public tableHeader = ["Particulars", "Amount"];
  ...
  private getReportData() {
    this.apiUrl = `CostCentre/RptCostSheet?fromDate=${this.fromdateSelected.toString().substring(3, 15)}&toDate=${this.todateSelected.toString().substring(3, 15)}`;
