...
@Component({
  selector: 'ngx-rpt-ratioanalysis',
  templateUrl: './rpt-ratioanalysis.component.html',
  styleUrls: ['./rpt-ratioanalysis.component.scss']
})
export class RptRatioanalysisComponent implements OnInit {

  public date = new Date().getFullYear();
  public fromdateSelected = new Date();
  public todateSelected = new Date();

  public pageNavigation = "Ratio Analysis";
  ...
  private getReportData() {
    this.apiUrl = `AccountReport/getRptRatioAnalysis?companyId=${this.companySelected.id}&sbuId=${this.branchSelected.id}&fromDate=${this.fromdateSelected.toString().substring(3, 15)}&toDate=${this.todateSelected.toString().substring(3, 15)}&noteName=`;
    this.commonService.getReportData(this.apiUrl).subscribe((returns: any) => {
      if (returns.success) {

        this.bodyData = returns.data;
        this.yearEndDate = this.todateSelected.toString().substring(3, 15) //this.bodyData[0].yearEndDate;
  ...
  public generateReport(buttonAction: any) {
    ...
    this.generatePdfCostSheet(buttonAction, fileName, content);
  }
