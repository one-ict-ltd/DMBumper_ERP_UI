...
@Component({
  selector: 'ngx-rpt-schedule-report',
  templateUrl: './rpt-schedule-report.component.html',
  styleUrls: ['./rpt-schedule-report.component.scss']
})
export class RptScheduleReportComponent implements OnInit {
  ...
  private getCrReport(reportFormat: any = 'pdf') {
    ...
    if (this.commonService.validateDates(fromDate, toDate)) {
      ...
      this.apiUrl = `AccountsReport/GetRptAccountScheduleReport?companyId=${this.ddlSelected.id
