...
@Component({
  selector: "ngx-rpt-accountgroupbook",
  templateUrl: "./rpt-accountgroupbook.component.html",
  styleUrls: ["./rpt-accountgroupbook.component.scss"],
})
export class RptAccountgroupbookComponent implements OnInit {
  public pageNavigation = "Ledger Book (By Group)";
  public tableHeader = [
    "#",
    "Date",
    "Voucher No",
  ...
  public RptButtonAction() {
    ...
    if (clicked == "preview") {
      ...
      this.GetGroupWiseLedgerBook("Pdf");
    } else if (clicked == "print") {
      //this.generateReport("print");
      this.GetGroupWiseLedgerBook("Pdf");
    } else if (clicked == "csv") {
      //this.onExportCSV();
      this.GetGroupWiseLedgerBook("Excel");
  ...
  GetGroupWiseLedgerBook(reportFormat: any) {
    /*
        this.apiUrl = `AccountReport/getRptAccountGroupBookWithNature?companyId=${this.ddlSelected.id
            ...
            .substring(3, 15)}&toDate=${this.todateSelected
              .toString()
              .substring(3, 15)}&reportType=${this.reportTypeSelected.id}&natureId=${this.accountClassId}`;
    */
    this.apiUrl = `AccountsReport/GetGroupWiseLedgerBook?reportFormat=${reportFormat}&companyId=${this.commonService.getCurrentCompany()}&sbuId=${this.branchSelected.id}&accountGroupId=${this.accountGroupIdLast}&fromDate=${this.commonService.DateFormat(this.fromdateSelected)}&toDate=${this.commonService.DateFormat(this.todateSelected)}&reportType=${this.reportTypeSelected.id}&natureId=${this.accountClassId}`;
  ...
  private getReportDataExcel() {
    ...
    ////////// Call common service for report data/////////
    this.apiUrl = `AccountReport/getRptAccountGroupBookWithNature?companyId=${this.ddlSelected.id}&sbuId=${this.branchSelected.id}&accountGroupId=${accountGroupId}&fromDate=${this.fromdateSelected.toString().substring(3, 15)}&toDate=${this.todateSelected.toString().substring(3, 15)}&reportType=${this.reportTypeSelected.id}&natureId=${this.accountClassId}`;
