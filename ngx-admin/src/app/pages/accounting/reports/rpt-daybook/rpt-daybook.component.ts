...
@Component({
  selector: "ngx-rpt-daybook",
  templateUrl: "./rpt-daybook.component.html",
  styleUrls: ["./rpt-daybook.component.scss"],
})
export class RptDaybookComponent implements OnInit {
  public pageNavigation = "Day Book";
  public tableHeader = [
    "#",
    "Voucher Date",
    "Voucher No",
  ...
  private getReportData() {
    ...
    this.apiUrl = `AccountReport/getRptDayBook?companyId=${this.ddlSelected.id
      }&sbuId=${this.branchSelected.id
      }&vouchertypeId=${typeId}&empId=${this.substituteEmployeeId}&fromDate=${this.fromDateSelected
        .toString()
        .substring(3, 15)}&toDate=${this.toDateSelected
          .toString()
          .substring(3, 15)}&amount=${this.amount}&remarks=${this.remarks}`;
  ...
  private getReportDataExcel() {
    ...
    this.apiUrl = `AccountReport/getRptDayBook?companyId=${this.ddlSelected.id}&sbuId=${this.branchSelected.id
      }&vouchertypeId=${typeId}&empId=${this.substituteEmployeeId}&fromDate=${this.fromDateSelected.toString().substring(3, 15)}&toDate=${this.toDateSelected.toString().substring(3, 15)}&amount=${this.amount}&remarks=${this.remarks}`;
