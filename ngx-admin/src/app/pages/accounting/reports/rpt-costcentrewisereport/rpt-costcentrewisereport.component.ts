...
// @Component({
//   selector: 'ngx-rpt-costcentrewisereport',
//   templateUrl: './rpt-costcentrewisereport.component.html',
//   styleUrls: ['./rpt-costcentrewisereport.component.scss']
// })
// export class RptCostcentrewisereportComponent implements OnInit {
...
export class RptCostcentrewisereportComponent implements OnInit {
  public pageNavigation = "Cost Centre Wise Report";
  public tableHeader = [
    "#",
    "Account Code",
    "Account Name",
  ...
  private getReportData() {
    ...
    this.setParam();
    this.apiUrl = `AccountReport/getRptCostCentreWiseReport?companyId=${this.ddlSelected.id}&sbuId=${this.branchSelected.id}&costCentreId=${costCentreId}&costCostCentreLocationId=${costCentreLocationId}&costCentreCategoryId=${costCentreCategoryId}&ledgerId=${ledgerId}&natureId=${natureId}&groupId=${groupId}&fromDate=${this.fromdateSelected.toString().substring(3, 15)}&toDate=${this.todateSelected
